...
const UnitForm: React.FC<RouteComponentProps<{ id: string }>> = ({ match }) => {
  ...
  return (
    <>
      <div className="unittop unittop-form">
        <Link to="/units">
          {" "}
          <button className="homeLandButton">Go to List</button>
        </Link>
        <Container>
          <form
          ...
          >
            ...
            <br />
            {errors.noOfBedrooms && (
              <p className="errorMsg">{errors.noOfBedrooms.message}</p>
            )}
            ...
            <br />
            {errors.noOfBaths && (
              <p className="errorMsg">{errors.noOfBaths.message}</p>
            )}
            ...
            />
            <br />
            {errors.noOfBalconies && (
              <p className="errorMsg">{errors.noOfBalconies.message}</p>
            )}
            ...
            <br />
            {errors.netArea && (
              <p className="errorMsg">{errors.netArea.message}</p>
            )}
            ...
            <br />
            {errors.commonArea && (
              <p className="errorMsg">{errors.commonArea.message}</p>
            )}
            ...
            <br />
            {errors.bookingPrice && (
              <p className="errorMsg">{errors.bookingPrice.message}</p>
            )}
